...
"""autogenerated by genpy from nodes_pkg/PointStamped.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import nodes_pkg.msg
import std_msgs.msg

class PointStamped(genpy.Message):
  _md5sum = "c63aecb41bfdfd6b7e1fac37c7cbe7bf"
  _type = "nodes_pkg/PointStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','nodes_pkg/Point']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.point is None:
        self.point = nodes_pkg.msg.Point()
    else:
      self.header = std_msgs.msg.Header()
      self.point = nodes_pkg.msg.Point()
